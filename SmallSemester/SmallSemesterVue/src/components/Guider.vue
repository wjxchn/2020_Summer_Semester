        ...
        <div class="container">
            <header class="blog-header py-3">
                <div class="row flex-nowrap justify-content-between align-items-center">
                    ...
                    <div class="col-4 text-center">
                        <a class="blog-header-logo guider-black" href="/">福报文档</a>
                    </div>
            ...
            <div class="collapse" id="collapseExample">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 unfold-link"><i class="el-icon-user"></i><a href="/teammanagement" class="guider-black">团队管理</a></div>
                    <div class="col-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 unfold-link"><i class="el-icon-delete"></i><a href="/trash" class="guider-black">回收站</a></div>
